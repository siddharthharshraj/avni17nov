...
description: "Jan Swasthya Sahyog collaborates with M.P. state government in Annupur district to screen tribal families for sickle cell disease. Using Avni field app, the team manages client data, coordinates efforts, and ensures end-to-end treatment completion."
date: "2020-01-06"
author: "Avni Team"
readTime: "3 min read"
tags: ["Health","Government","Case Study"]
featured: false
---
...
![Lab sample collection and data entry in Avni](/images/case-studies/jss-sickle-sample-collection.jpeg "Lab sample collection and data entry in Avni")
