              ...
              <div className={`grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center ${
                ...
                <div className={`space-y-6 ${service.imagePosition === 'left' ? 'lg:order-2' : ''}`}>
                  ...
                  <div className="pt-2">
                    <Link 
                      href="/demo"
                      className="inline-block px-6 py-3 border-2 border-[#1F7A63] text-[#1F7A63] font-anek font-semibold text-[16px] rounded-full hover:bg-[#1F7A63] hover:text-white transition-all"
                    >
                      Try Avni →
                    </Link>
                  </div>
