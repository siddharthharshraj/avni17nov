...
export default function Home() {
  return (
    <>
      ...
      <AnnouncementBanner />
      <main>
        {/* Landing — order follows the design-review brief.
            Components for sections not used here (TrustedBy, WhatAvniDoes,
            WhyChooseAvni, Solutions, Transparency, Testimonials, CTASection,
            Newsletter) still live in components/sections and can be
            re-mounted by uncommenting the legacy block below. */}
        <Hero />                {/* 1. Hero */}
        <Problem />             {/* 2. Problem */}
        ...
        {/*
          --- Legacy sections (Phase 3: removed from homepage) ---
          Re-mount any of these by uncommenting:
