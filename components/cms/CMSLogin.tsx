...
const AUTH_BACKEND_URL = process.env.NEXT_PUBLIC_AUTH_BACKEND_URL || 'https://avni-auth-backend.onrender.com';
        ...
        <div className="mt-8 space-y-6">
          ...
          {loading && (
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-gray-600">Redirecting to Google...</p>
            </div>
          )}
