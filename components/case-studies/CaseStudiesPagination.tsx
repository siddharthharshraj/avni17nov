/**
 * Case Studies Pagination Component
...
interface CaseStudiesPaginationProps {
  currentPage: number;
  totalPages: number;
  onPageChange: (page: number) => void;
}

export default function CaseStudiesPagination({ currentPage, totalPages, onPageChange }: CaseStudiesPaginationProps) {
